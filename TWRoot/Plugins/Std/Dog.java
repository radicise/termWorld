...
public class Dog extends Entity {
	...
	boolean healed;
	public Dog(int x, int y, long data, short health) {
		type = 1;
	...
	public Dog(int x, int y, long data, short health, Item[] inv) {
		type = 1;
		inventory = new Item[invSpace];
	...
	public static Dog fromDataStream(DataInputStream readFrom) throws Exception {
